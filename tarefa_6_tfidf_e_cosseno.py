...
for url_1 in pegarconteudos1:#pega o conteudo de cada paragrafo
  corpus.append(url_1.get_text())#adiciona o conteudo de cada paragrafo em uma lista
...
for url_2 in pegarconteudos2:#pega o conteudo de cada paragrafo do url 2
  corpus.append(url_2.get_text())#adiciona o conteudo de cada paragrafo da url 2 em uma lista
...
for url_3 in pegarconteudos3:#pega o conteudo de cada paragrafo do url 3
  corpus.append(url_3.get_text())#adiciona o conteudo de cada paragrafo da url 3 em uma lista
...
for url_4 in pegarconteudos4:#pega o conteudo de cada paragrafo do url 4
  corpus.append(url_4.get_text())# adiciona o conteudo de cada paragrafo da url 4 em uma lista
...
for url_5 in pegarconteudos5:#pega o conteudo de cada paragrafo do url 5
  corpus.append(url_5.get_text())#adiciona o conteudo de cada paragrafo da url 5 em uma lista
corpuslist.append(corpus)#adiciona a lista corpus em uma lista
...
for corpus in corpuslist:#pega o conteudo de cada paragrafo da lista corpus
  for frase in corpus:#pega o conteudo de cada paragrafo da lista corpus
    numerodefrases += 1#incrementa o numero de frases
    for palavra in frase.split(' '):#pega o conteudo de cada paragrafo da lista corpus
...
for corpus in corpuslist:#pega o conteudo de cada paragrafo da lista corpus
  for frases in corpus:# pega o conteudo de cada paragrafo da lista corpus
    for palavra in frases.split(' '):#pega o conteudo de cada paragrafo da lista corpus
...
for corpus in corpuslist:#pega o conteudo de cada paragrafo da lista corpus
  for frases in corpus:#pega o conteudo de cada paragrafo da lista corpus
    numerodepalavras = len(frases.split(' '))#pega o conteudo de cada paragrafo da lista corpus
...
IDF = []#lista de IDF
for palavra in range(len(palavras)):#pega o conteudo de cada paragrafo da lista corpus
  palavrasanalisadas = 0#numero de palavras analisadas
  for frasesanalisadas in BOW:#pega o conteudo de cada paragrafo da lista corpus
...
for a in range(len(TFIDF)):#pega o conteudo de cada paragrafo da lista corpus
  for b in range(len(TFIDF[0])):#pega o conteudo de cada paragrafo da lista corpus
...
array = 0
for vector in TFIDF:#pega o conteudo de cada paragrafo da lista corpus
  a = array#pega o conteudo de cada paragrafo da lista corpus
  while a < len(TFIDF):
